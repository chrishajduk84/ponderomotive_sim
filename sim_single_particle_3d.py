...
def integrate_b_field(field,x_range, y_range, z_range, step_size=0.1/1000):
    sum = 0
...
# Data File
f = open("sim_output.csv", 'w', newline='')
...
for i in range(NUM_STEPS):
    ...
    # ∇xE = -dB/dt
    #TODO: Add thread pool to speed this up
